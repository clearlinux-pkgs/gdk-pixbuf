...
%prep
%setup -q -n gdk-pixbuf-2.42.10
cd %{_builddir}/gdk-pixbuf-2.42.10
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a gdk-pixbuf-2.42.10 buildavx2
popd
pushd ..
cp -a gdk-pixbuf-2.42.10 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701959680
...
CFLAGS="$CFLAGS -m64 -march=x86-64-v4 -Wl,-z,x86-64-v4 -O3 -mprefer-vector-width=512" CXXFLAGS="$CXXFLAGS -m64 -march=x86-64-v4 -Wl,-z,x86-64-v4 -mprefer-vector-width=512" LDFLAGS="$LDFLAGS -m64 -march=x86-64-v4" meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dtiff=disabled \
