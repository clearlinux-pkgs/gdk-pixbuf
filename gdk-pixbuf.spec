...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732036156
...
-Drelocatable=false \
-Dbuiltin_loaders=png,jpeg,xpm,bmp,ico,pnm,xbm \
-Dothers=enabled  builddir
ninja -v -C builddir
GOAMD64=v3
...
-Drelocatable=false \
-Dbuiltin_loaders=png,jpeg,xpm,bmp,ico,pnm,xbm \
-Dothers=enabled  builddiravx512
